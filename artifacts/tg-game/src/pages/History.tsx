...
const GAME_NAMES: Record<string, string> = { apple: "🍎 Olma Omadi", dice: "🎲 Zar", aviator: "✈️ Aviator", spin: "🎡 Aylanadur", blackjack: "🃏 Blackjack", slots: "🎰 Slot", parity: "🔢 Toq-Juft", mines: "💣 Mines", roulette: "🎡 Ruletka" };
