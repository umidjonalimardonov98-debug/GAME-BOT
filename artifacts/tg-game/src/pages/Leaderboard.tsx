...
function rankStyle(rank: number) {
  if (rank === 1) return { bg: "linear-gradient(135deg, rgba(251,191,36,0.12), rgba(245,158,11,0.06))", border: "1px solid rgba(251,191,36,0.35)", glow: "0 0 20px rgba(251,191,36,0.08)" };
  ...
  return { bg: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", glow: "none" };
}
  ...
  return (
    <div className="flex flex-col gap-2">
      {data.map((e) => {
        ...
        return (
          <div key={e.rank} className="flex items-center gap-3 rounded-2xl px-4 py-3"
