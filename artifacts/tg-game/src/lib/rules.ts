...
export const GAME_RULES: Record<string, { emoji: string; rules: Rules }> = {
  ...
  slots: {
    emoji: "🎰",
    rules: {
      uz: ["Tikishni kiriting va SPIN bosing", "3 ta g'ildirak tez aylanadi", "7️⃣7️⃣7️⃣ = x10 jekpot", "3 bir xil = x3, 2 bir xil = x1.5"],
      ru: ["Введите ставку и нажмите СПИН", "3 барабана быстро вращаются", "7️⃣7️⃣7️⃣ = джекпот x10", "3 одинаковых = x3, 2 = x1.5"],
      en: ["Place a bet and hit SPIN", "Three reels spin fast", "7️⃣7️⃣7️⃣ = x10 jackpot", "Three of a kind = x3, two = x1.5"],
    },
  },
  parity: {
    emoji: "🔢",
